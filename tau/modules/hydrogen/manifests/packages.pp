class hydrogen::packages{ 


	$centos_packages = [ 'rpcbind', 'environment-modules', 'xorg-x11-xauth', 'mesa-libGLU', 'mesa-libGLU-devel', 
		    'zlib', 'zlib-devel', 'zlib-static',
		    'ghostscript','ghostscript-fonts','libXfont','urw-fonts','xorg-x11-font-utils','lapack-devel','gcc-c++','grace','PyQt4','libXdmcp','xorg-x11-apps','libXtst','tmux','autojump','redhat-lsb-core','tcsh'
	]
